<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Stelle sicher, dass du ein langes, zufälliges Passwort für dein Konto verwendest.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Neues Passwort bestätigen')" />
