<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Vereine</h2>
    </x-slot>
    ...
    <div class="lg:py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="{{ route('clubs.create') }}" class="btn bg-info-content text-base-100 mb-4">Verein anlegen</a>
                </div>
